...
exports.incrementBuildNumber = exports.getBuildNumber = void 0;
...
function getBuildNumber() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const response = yield axios_1.default.request(configGet);
...
function incrementBuildNumber(number) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const response = yield axios_1.default.request(configPut);
            return response.data.number;
        }
        catch (ex) {
            console.log(ex);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(2186));
const buildNumber_1 = __nccwpck_require__(7658);
...
function getMatrixItem(platformName, buildEnvironment, slackData, slackChannel, evironmentDataJSON, buildConfig, buildConfigDataJSON) {
...
function getCustomPlatformName(platformName) {
    switch (platformName) {
        case Android:
            {
                return "Android";
